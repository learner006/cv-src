...
class EditorManager {
  ...
  setNewColorUsingHistory(p_histIndex) {
    if (p_histIndex >= 0 && p_histIndex < this.colorsHistory.length) {
      ...
      this.editorManagerView.updateColorsHistory(".saved-color",p_histIndex);
    }
  }
  /////////////////////////////////////////////////////////////////////////
  //
...
class EditorManagerView {
  ...
  updateColorsHistory(p_Selector, p_SelectedIndex) {
    document.querySelectorAll(p_Selector).forEach(
      (el,idx) => {
